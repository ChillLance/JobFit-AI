...
export function ActiveProfileBanner() {
  ...
  return (
    <section className="mb-6 rounded-2xl border border-orange-900/50 bg-orange-50 px-5 py-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-2 text-xs text-stone-400">{p.footnote}</p>
        </div>

        <Link
          href="/profiles"
          className="shrink-0 rounded-full border border-orange-300 bg-orange-600/10 px-3 py-1.5 text-xs font-semibold text-orange-800 transition hover:bg-orange-600/20"
        >
          {p.manage}
        </Link>
      </div>
